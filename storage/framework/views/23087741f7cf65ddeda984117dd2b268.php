            ...
            <div class="login-content">
                ...
                <form action="<?php echo e(route('register')); ?>" method="POST">
                    ...
                    <div class="text-center">
                        Already have an account? <a href="<?php echo e(route('login')); ?>" class="text-muted fw-bold text-decoration-none">Login here</a>
                    </div>
                </form>
...
<?php /**PATH /Users/lian/Documents/Kasir Resto/tubes-kasir-resto/resources/views/auth/register.blade.php ENDPATH**/ ?>