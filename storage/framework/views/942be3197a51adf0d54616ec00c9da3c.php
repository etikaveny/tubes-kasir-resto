        ...
        <div class="row h-100 g-0">
            ...
            <div class="col-md-2 p-4 d-flex flex-column h-100" style="background-color: #F5F5EC; border-right: 1px solid #EAE5D9;">
                 ...
                 <nav class="nav flex-column gap-2 flex-grow-1">
                     <a class="nav-link <?php echo e(request()->routeIs('manager.dashboard') ? 'active-nav' : ''); ?> text-secondary d-flex align-items-center gap-3 py-3 px-3 rounded-4" href="<?php echo e(route('manager.dashboard')); ?>">
                     ...
                     <a class="nav-link <?php echo e(request()->routeIs('manager.products*') ? 'active-nav' : ''); ?> text-secondary d-flex align-items-center gap-3 py-3 px-3 rounded-4" href="<?php echo e(route('manager.products.index')); ?>">
                 ...
                 <div class="mt-auto pt-4 border-top">
                     <a href="<?php echo e(route('manager.profile')); ?>" class="text-decoration-none d-flex align-items-center gap-3 mb-3">
...
<?php /**PATH /Users/lian/Documents/Kasir Resto/tubes-kasir-resto/resources/views/layouts/app.blade.php ENDPATH**/ ?>