...
<div class="row g-4">
        ...
        <div class="card border-0 rounded-4 shadow-sm p-4" style="background-color: #B0A695; color: #4A4A35;">
            ...
            <div class="row">
                <div class="col-md-4 d-flex align-items-center gap-3">
                    <div class="bg-dark text-white rounded-circle d-flex align-items-center justify-content-center" style="width:50px;height:50px;"><i class="bi bi-person fw-bold fs-4"></i></div>
                    <div>
    ...
    <div class="col-lg-4">
        ...
        <div class="bg-white rounded-pill px-4 py-2 mb-4 d-flex justify-content-between align-items-center shadow-sm">
            <span><i class="bi bi-calendar"></i> Minggu, 22 Maret 2026</span>
        ...
        <div class="d-flex flex-column gap-3">
            ...
            <div class="card border-0 rounded-4 shadow-sm p-4" style="background-color: #B0A695;">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle bg-dark text-white d-flex align-items-center justify-content-center" style="width:40px;height:40px;">$</div>
            ...
            <div class="card border-0 rounded-4 shadow-sm p-4" style="background-color: #EAE5D9;">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle bg-secondary text-white d-flex align-items-center justify-content-center" style="width:40px;height:40px;"><i class="bi bi-receipt"></i></div>
            ...
            <div class="card border-0 rounded-4 shadow-sm p-4" style="background-color: #B0A695;">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle bg-dark text-white d-flex align-items-center justify-content-center" style="width:40px;height:40px;"><i class="bi bi-receipt"></i></div>
             ...
             <div class="card border-0 rounded-4 shadow-sm p-4" style="background-color: #EAE5D9;">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle bg-secondary text-white d-flex align-items-center justify-content-center" style="width:40px;height:40px;"><i class="bi bi-arrow-return-left"></i></div>
            ...
            <!-- Refund Monthly -->
             <div class="card border-0 rounded-4 shadow-sm p-4" style="background-color: #B0A695;">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle bg-dark text-white d-flex align-items-center justify-content-center" style="width:40px;height:40px;"><i class="bi bi-arrow-return-left"></i></div>
             ...
             <!-- Customers -->
             <div class="card border-0 rounded-4 shadow-sm p-4" style="background-color: #EAE5D9;">
                <h6 class="text-secondary fw-bold mb-2">Total Pelanggan Harian</h6>
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle bg-secondary text-white d-flex align-items-center justify-content-center" style="width:40px;height:40px;"><i class="bi bi-people"></i></div>
                    <h3 class="fw-bold m-0">52</h3>
                </div>
            </div>
...
<script>
    ...
    new Chart(ctx, {
        type: 'line',
        data: {
            labels: ['08.00', '10.00', '12.00', '14.00', '16.00', '18.00', '20.00', '22.00', '24.00'],
            datasets: [{
                label: 'Orderan',
                data: [5, 30, 50, 25, 15, 25, 40, 35, 5],
                borderColor: '#3E3C38',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lian/Documents/Kasir Resto/tubes-kasir-resto/resources/views/manager/dashboard.blade.php ENDPATH**/ ?>