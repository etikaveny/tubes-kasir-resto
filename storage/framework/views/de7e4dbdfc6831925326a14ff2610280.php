...
<head>
    ...
    <style>
        ...
        .image-side {
            ...
            background-image: url('https://images.unsplash.com/photo-1554118811-1e0d58224f24'); /* Restaurant vibe */
            ...
            <div class="login-content">
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST">
                    ...
                    <div class="text-center">
                        ...
                        <div class="small">Don't have an account? <a href="<?php echo e(route('register')); ?>" class="fw-bold text-decoration-none text-dark">Create one</a></div>
                    </div>
                </form>
...
<?php /**PATH /Users/lian/Documents/Kasir Resto/tubes-kasir-resto/resources/views/auth/login.blade.php ENDPATH**/ ?>